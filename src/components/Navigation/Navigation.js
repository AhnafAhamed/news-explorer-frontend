...
function Navigation({onMenuClick, onCloseClick}) {
    return (
        <nav className="navigation ">
            ...
            <img src={menu} onClick={onMenuClick} alt="menu" className="navigation__item navigation__menu-mobile" />
            <img src={close} onClick={onCloseClick} alt="close" className="navigation__close-mobile" />
        </nav>
    )
}
