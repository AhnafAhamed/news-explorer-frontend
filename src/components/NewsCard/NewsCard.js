    ...
    return (
        <li className="news-card">
            <div className="news-card__image-container">
                ...
                { route.pathname === "/" ? <button className="news-card__icon news-card__icon-bookmark news-card__icon-bookmark_saved"></button> : <button  className="news-card__icon news-card__icon-delete"></button> }
                { !isLoggedIn ? <p className="news-card__save-prompt">Sign in to save articles</p> : ''}
                { route.pathname === "/" ? <p className="news-card__delete-prompt">Remove from saved</p> : ''}
            </div>
